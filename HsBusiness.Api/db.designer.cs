...
namespace HsBusiness.Api
{
    ...
    partial void InsertVCode(VCode instance);
    partial void UpdateVCode(VCode instance);
    partial void DeleteVCode(VCode instance);
    #endregion
		
		public dbDataContext() : 
				base(global::System.Configuration.ConfigurationManager.ConnectionStrings["HsSjConnectionString1"].ConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<VCode> VCode
		{
			get
			{
				return this.GetTable<VCode>();
			}
		}
	}
    ...
    partial void OnIsReadChanged();
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="SmallBalance_SmaBaRead", Storage="_SmallBalance", ThisKey="SmBaID", OtherKey="ID", IsForeignKey=true)]
		public SmallBalance SmallBalance
		{
			get
			{
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.VCode")]
	public partial class VCode : INotifyPropertyChanging, INotifyPropertyChanged
	{
